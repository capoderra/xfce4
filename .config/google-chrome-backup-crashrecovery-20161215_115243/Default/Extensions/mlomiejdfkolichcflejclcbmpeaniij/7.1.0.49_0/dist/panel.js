...
"use strict";var Router=require("./routers/Router.js"),msg=require("../utils/msg")("panel_app"),globals=require("../../../src/globals"),sendMessageToBackground=msg.sendMessageToBackground;window.t=function(e){var r=Array.prototype.slice.call(arguments,1);return chrome.extension.getBackgroundPage().i18n.t(e,r)},window.App={GHOSTERY_DOMAIN:globals.GHOSTERY_DOMAIN},new Router,sendMessageToBackground("ping","engaged");

},{"../../../src/globals":49,"../utils/msg":22,"./routers/Router.js":4}],2:[function(require,module,exports){
'use strict';
...
var Collections = {
	...
	BlockingCategories: Backbone.Collection.extend({
		...
		buildCollectionData: function (trackerList, selectedAppIds, pageUnblocks, pageBlocks, showSrcs) {
			var categories = {},
			    categoryName,
			    categoryArray = [];
...
},{"../../utils/msg":22,"../models/Models":3,"backbone":39,"underscore":47}],3:[function(require,module,exports){
'use strict';
...
},{"backbone":39}],4:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":48,"../../utils/msg":22,"../collections/Collections":2,"../views/PanelView":18,"backbone":39,"underscore":47}],5:[function(require,module,exports){
...
var AccountSuccessView = ParentView.extend({
	...
	render: function () {
		...
		$('.signin-success-email').html(this.panelModel.get('email'));
...
},{"../../../templates/precompiled/account_success":24,"./ParentView":19,"jquery":45}],8:[function(require,module,exports){
'use strict';
...
var BlockingCategories = ParentView.extend({
	...
	render: function () {
		...
		this.collection.each(category => {
			...
			this.$el.append(blockingCategory.render().el);
...
},{"./BlockingCategory":9,"./ParentView":19}],9:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/blocking_category":25,"../collections/Collections":2,"./BlockingTrackers":11,"./ParentView":19}],10:[function(require,module,exports){
(function (global){
'use strict';
...
var ParentView = require('./ParentView'),
    html = require('../../../templates/precompiled/blocking_tracker'),
...
var BlockingTracker = ParentView.extend({
	...
	render: function () {
		...
		this.model.trigger('change:blocked change:ss_allowed change:ss_blocked change:showSrcs change:warningCompatibility');
		return this;
	},
...
},{"../../../../src/common":48,"../../../templates/precompiled/blocking_tracker":26,"../vendor/clamp.custom.js":5,"./ParentView":19,"foundation":38,"jquery":45}],11:[function(require,module,exports){
'use strict';
...
var BlockingTrackers = ParentView.extend({
	...
	render: function () {
		...
		this.collection.each(tracker => {
			var blockingTracker = new BlockingTracker({
				model: tracker,
				customEvents: this.customEvents
			});
			this.$el.append(blockingTracker.render().el);
...
},{"./BlockingTracker":10,"./ParentView":19}],12:[function(require,module,exports){
'use strict';
...
var BlockingView = ParentView.extend({
	...
	customEvents: {},
	events: {
		'click .blocking-header .title': 'clickCloseBlockingPanel',
	...
	updateTrackers: function () {
		...
		this.categoriesView.collection.buildCollectionData(trackerList, selectedAppIds, pageUnblocks, pageBlocks, showSrcs);
	...
	clickCloseBlockingPanel: function () {
		if (BROWSER_NAME === 'firefox' || BROWSER_NAME === 'edge') {
			return;
		}
		this.model.set('panel_expanded', false);
		this.model.save();
	},
...
},{"../../../../src/common":48,"../../../templates/precompiled/blocking_view":27,"../collections/Collections":2,"./BlockingCategories":8,"./ParentView":19,"jquery":45}],13:[function(require,module,exports){
'use strict';
...
var CreateAccountView = ParentView.extend({
	...
	render: function () {
		...
		this.customEvents.trigger("expandPanel");
...
},{"../../../../src/common":48,"../../../templates/precompiled/create_account_view":28,"./ParentView":19,"jquery":45}],14:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":48,"../../../templates/precompiled/forgot_password":29,"./ParentView":19,"jquery":45}],15:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../../../src/common":48,"../../../templates/precompiled/header_view":31,"./ParentView":19,"foundation":38,"jquery":45}],16:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/help_view":32,"./ParentView":19,"jquery":45}],17:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":48,"../../../templates/precompiled/login_view":34,"./ParentView":19,"jquery":45}],18:[function(require,module,exports){
(function (global){
'use strict';
...
var PanelView = ParentView.extend({
	...
	initialize: function (options) {
		this.customEvents = options.customEvents;
		this.listenTo(this.customEvents, "expandPanel", this.expandPanel);
		this.listenTo(this.customEvents, "collapsePanel", this.collapsePanel);
		this.listenTo(this.customEvents, "togglePanel", this.togglePanel);
		...
		this.onMessage('onLanguageUpdated', () => {
	...
	renderModal: function () {
		...
		if (!upgrade_dismissed) {
			if (!this.$('#ghostery-app').hasClass('expanded') && !this.model.get('panel_expanded')) {
				setTimeout(this.expandPanel, 0);
			}
			...
			if (!this.model.get('panel_expanded')) {
				this.collapsePanel();
			}
	...
	setModalLocation: function (position) {
		setTimeout(() => {
			$('.location-container').removeClass('first second').addClass(position);
		}, 100);
	},
	...
	expandPanel: function () {
		this.$('#ghostery-app').addClass('expanded');
	},
	collapsePanel: function () {
		this.$('#ghostery-app').removeClass('expanded');
	},
	togglePanel: function () {
		if (this.$('#ghostery-app').hasClass('expanded')) {
			this.collapsePanel();
		} else {
			this.expandPanel();
		}
...
},{"../../../templates/precompiled/account_modal":23,"../../../templates/precompiled/ghostrank_modal":30,"../../../templates/precompiled/learn_more_modal":33,"../../../templates/precompiled/updated_modal":37,"../../utils/msg":22,"../models/Models":3,"./AccountSuccessView":7,"./CreateAccountView":13,"./ForgotPasswordView":14,"./HeaderView":15,"./HelpView":16,"./LoginView":17,"./ParentView":19,"./SettingsView":20,"./SummaryView":21,"foundation":38,"jquery":45,"underscore":47}],19:[function(require,module,exports){
'use strict';
...
},{"../../utils/msg":22,"backbone":39}],20:[function(require,module,exports){
(function (global){
'use strict';
...
var SettingsView = ParentView.extend({
	...
	toggleShowReloadBanner: function () {
		var reload_banner_status = {
			show_time: 0,
			dismissals: [],
			show: $('#settings-show-reload-banner')[0].checked
		};
		this.model.set('reload_banner_status', reload_banner_status);
		this.model.save();
	},
	updateShowReloadBanner: function () {
		$('#settings-show-reload-banner')[0].checked = this.model.get('reload_banner_status').show;
	},

	toggleShowTrackersBanner: function () {
		var trackers_banner_status = {
			show_time: 0,
			dismissals: [],
			show: $('#settings-show-trackers-banner')[0].checked
		};
		this.model.set('trackers_banner_status', trackers_banner_status);
		this.model.save();
	},
	updateShowTrackersBanner: function () {
		$('#settings-show-trackers-banner')[0].checked = this.model.get('trackers_banner_status').show;
	},
...
},{"../../../../src/common":48,"../../../templates/precompiled/settings_view":35,"./ParentView":19,"foundation":38,"jquery":45,"moment/min/moment-with-locales.min.js":46,"underscore":47}],21:[function(require,module,exports){
'use strict';
...
var SummaryView = ParentView.extend({
	...
	customEvents: {},
	events: {
		'click .tracker-count-total, .not-scanned-title': 'clickSummaryTitle',
	...
	initialize: function (options) {
		...
		this.listenTo(this.model, 'change:panel_expanded', this.updatePanelExpanded);
		...
		this.model.trigger('change:panel_expanded change:trackerCategories change:trackerList change:pageHost change:categoriesDonutData change:trackerCounts change:cta_status change:sitePolicy change:paused_blocking');
		setTimeout(() => {
	...
	updatePanelExpanded: function () {
		var panel_expanded = this.model.get('panel_expanded');
		...
		if (panel_expanded) {
			...
			this.closeBlocking();
			this.customEvents.trigger("collapsePanel");
		}
	},
	...
	clickSummaryTitle: function (event) {
		if (BROWSER_NAME === 'firefox' || BROWSER_NAME === 'edge') {
			return;
		}
		var panel_expanded = this.model.get('panel_expanded');

		this.model.set('panel_expanded', !panel_expanded);
		this.model.save();
	},
	...
	openBlocking: function () {
		var panel_expanded = this.model.get('panel_expanded');

		if (!panel_expanded || !this.blockingView) {
			this.model.set('panel_expanded', true);
			this.model.save();
		}
	},
	filterTrackers: function (filter) {
...
},{"../../../../src/common":48,"../../../templates/precompiled/summary_view":36,"../vendor/jquery.animateNumber.js":6,"./BlockingView":12,"./ParentView":19,"d3":42,"jquery":45,"underscore":47}],22:[function(require,module,exports){
'use strict';
...
},{"jquery":45,"underscore":47}],40:[function(require,module,exports){
