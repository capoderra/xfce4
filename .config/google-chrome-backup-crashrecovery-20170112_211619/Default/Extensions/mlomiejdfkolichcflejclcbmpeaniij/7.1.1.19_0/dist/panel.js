...
},{"../../../src/globals":54,"../utils/msg":22,"./routers/Router.js":4}],2:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../utils/msg":22,"../collections/Collections":2,"../views/PanelView":18,"backbone":43,"underscore":52}],5:[function(require,module,exports){
...
},{"../../../../src/common":53,"../vendor/clamp.custom.js":5,"./ParentView":19,"foundation":42,"jquery":49}],11:[function(require,module,exports){
'use strict';
...
var BlockingTrackers = ParentView.extend({
	...
	render: function () {
		...
		this.collection.each(tracker => {
			...
			trackers += html.replace('@', tracker.get('name'));
		});
...
},{"../../../../src/common":53,"../../../templates/precompiled/blocking_view":28,"../collections/Collections":2,"./BlockingCategories":8,"./ParentView":19,"jquery":49}],13:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/create_account_view":29,"./ParentView":19,"jquery":49}],14:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/forgot_password":30,"./ParentView":19,"jquery":49}],15:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/header_view":34,"./ParentView":19,"foundation":42,"jquery":49}],16:[function(require,module,exports){
'use strict';
...
},{"../../../templates/precompiled/help_view":35,"./ParentView":19,"jquery":49}],17:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/login_view":37,"./ParentView":19,"jquery":49}],18:[function(require,module,exports){
(function (global){
'use strict';
...
var PanelView = ParentView.extend({
	...
	events: {
		...
		'click .modal-metrics-learn-more': 'clickMetricsLearnMore',
	...
	renderModal: function () {
		var ghostrank = this.model.get('ghostrank'),
		    ...
		    install_random_number = this.model.get('install_random_number'),
		    is_second = this.model.get('is_second') || false,
		    is_second_b = this.model.get('is_second_b') || false,
		...
		if (!upgrade_dismissed) {
			...
			if (install_random_number <= 50) {
				this.templateGhostrank = this.templateGhostrank || require('../../../templates/precompiled/ghostrank_modal_version_b');
				this.renderModalHelper(this.templateGhostrank(this.model.toJSON()));
				this.$('#ghostrank-modal').addClass('raised-top');
			} else {
				this.templateGhostrank = this.templateGhostrank || require('../../../templates/precompiled/ghostrank_modal');
				this.renderModalHelper(this.templateGhostrank(this.model.toJSON()));

				this.$('#ghostrank-modal .location-container').addClass('show-third-circle');
			}
		} else if (!account_dismissed && !logged_in) {
			this.$('#ghostrank-modal').removeClass('raised-top');
			if (is_second) {
				...
				this.templateMetrics = this.templateMetrics || require('../../../templates/precompiled/ghostrank_modal_version_c');
				this.renderModalHelper(this.templateMetrics(this.model.toJSON()));
				this.$('#ghostrank-modal-version-c .location-container').addClass('show-third-circle');
				this.setModalLocation('second');
			} else if (is_third) {
				this.templateAccount = this.templateAccount || require('../../../templates/precompiled/account_modal');
				this.renderModalHelper(this.templateAccount(this.model.toJSON()));
				this.$('#account-modal .location-container').addClass('show-third-circle');
	...
	clickModalBack: function () {
		var install_random_number = this.model.get('install_random_number');
		if (install_random_number <= 50) {
			this.templateGhostrank = this.templateGhostrank || require('../../../templates/precompiled/ghostrank_modal_version_b');
		} else {
			this.templateGhostrank = this.templateGhostrank || require('../../../templates/precompiled/ghostrank_modal');
	...
	clickMetricsLearnMore: function () {
		this.templateMetricsLearnMore = this.templateMetricsLearnMore || require('../../../templates/precompiled/metrics_learn_more_modal');
		this.$('#ghostrank-modal').html(this.templateMetricsLearnMore(this.model.toJSON()));
	},
	...
	clickGhostrankOptIn: function () {
		...
		if (install_random_number <= 50) {
			...
			this.model.set('is_second_b', true);
		}
	...
	clickMetricsOptIn: function () {
		this.model.set('is_second_b', false);
...
},{"../../../templates/precompiled/account_modal":23,"../../../templates/precompiled/ghostrank_modal":31,"../../../templates/precompiled/ghostrank_modal_version_b":32,"../../../templates/precompiled/ghostrank_modal_version_c":33,"../../../templates/precompiled/learn_more_modal":36,"../../../templates/precompiled/metrics_learn_more_modal":38,"../../../templates/precompiled/updated_modal":41,"../../utils/msg":22,"../models/Models":3,"./AccountSuccessView":7,"./CreateAccountView":13,"./ForgotPasswordView":14,"./HeaderView":15,"./HelpView":16,"./LoginView":17,"./ParentView":19,"./SettingsView":20,"./SummaryView":21,"foundation":42,"jquery":49,"underscore":52}],19:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/settings_view":39,"./ParentView":19,"foundation":42,"jquery":49,"moment/min/moment-with-locales.min.js":50,"underscore":52}],21:[function(require,module,exports){
'use strict';
...
},{"../../../../src/common":53,"../../../templates/precompiled/summary_view":40,"../vendor/jquery.animateNumber.js":6,"./BlockingView":12,"./ParentView":19,"d3":46,"jquery":49,"underscore":52}],22:[function(require,module,exports){
'use strict';
...
"use strict";module.exports=function(n){var l,a="";return a+='<div id="ghostrank-modal-version-b">\n\t<div class="modal-title">'+(null==(l=t("panel_modal_ghostrank_vb_title"))?"":l)+"</div>\n\t<p>\n\t\t<b>"+(null==(l=t("panel_modal_ghostrank_vb_p1_header"))?"":l)+"</b><br>\n\t\t"+(null==(l=t("panel_modal_ghostrank_vb_p1"))?"":l)+"\n\t</p>\n\t<p>\n\t\t<b>"+(null==(l=t("panel_modal_ghostrank_vb_p2_header"))?"":l)+"</b><br>\n\t\t"+(null==(l=t("panel_modal_ghostrank_vb_p2"))?"":l)+"\n\t</p>\n\t<p><b>"+(null==(l=t("panel_modal_ghostrank_vb_p3"))?"":l)+'</b></p>\n\t<div class="modal-button-container">\n\t\t<button class="button ghostrank-opt-in">'+(null==(l=t("panel_modal_ghostrank_opt_in"))?"":l)+'</button>\n\t\t<div class="links">\n\t\t\t<a class="ghostrank-opt-out">'+(null==(l=t("panel_modal_ghostrank_opt_out"))?"":l)+'</a>\n\t\t</div>\n\t</div>\n\t<div class="location-container">\n\t\t<svg height="8" width="22">\n\t\t\t<circle class="first-circle" cx="4" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t\t<circle class="second-circle" cx="18" cy="4" r="4" stroke="none" fill="#d8d8d8" />\n\t\t</svg>\n\t</div>\n</div>\n'};
...
"use strict";module.exports=function(l){var n,e="";return e+='<button class="modal-back" type="button"></button>\n<p>'+(null==(n=t("panel_modal_metrics_learn_more_subtitle"))?"":n)+"</p>\n<p>"+(null==(n=t("panel_modal_learn_more_paragraph"))?"":n)+"</p>\n<ul>"+(null==(n=t("panel_modal_learn_more_end"))?"":n)+"</ul>\n"};
...
},{"buffer":45,"ua-parser-js":51}],54:[function(require,module,exports){
'use strict';
